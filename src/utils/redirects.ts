export default {
  ...
  "publisering/dinpensjon": {
    ...
    beskrivelse: `Du har blitt sendt fra din pensjon. Her kan du legge til eller endre <b>kontaktinformasjon, midlertidig adresse og kontonummer</b>.`,
  ...
  "skjema/endringalderspensjon": {
    ...
    beskrivelse: `Du har blitt sendt fra endring i alderspensjon. Her kan du legge til eller endre <b>kontaktinformasjon, midlertidig adresse og kontonummer</b>.`,
    knapp: "Gå tilbake til alderspensjon"
  },
  "skjema/uforetrygd": {
  ...
  "publisering/uforetrygd": {
    ...
    beskrivelse: `Du har blitt sendt fra uføretrygd. Her kan du legge til eller endre <b>kontaktinformasjon, midlertidig adresse og kontonummer</b>.`,
    knapp: "Gå tilbake til uføretrygd"
  },
  "skjema/skjemaoversikt": {
    allowed: `https%3A%2F%2Ftjenester?-?.?..nav.no%2Fpselv%2Fskjema%2Fskjemaoversikt.jsf.*`,
    beskrivelse: `Du har blitt sendt skjemaoversikt. Her kan du legeg til eller endre <b>kontaktinformasjon, midlertidig adresse og kontonummer</b>.`,
