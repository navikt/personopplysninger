export default [
  {
    ...
    content: {
      __html: 'Hvis opplysninger om deg er feil, kan du be om at de blir rettet. \n' +
    ...
    'vil arkivplikten ofte gjøre at opplysninger må oppbevares \n' +
    'som dokumentasjon.\n' +
    'Hvis du vil be om å få rettet eller slettet opplysninger, må du henvende deg  til NAV Kontaktsenter, tlf. 55 55 33 33, \n' +
    'eller bruke Send beskjed til NAV.  \n' +
    '\n' +
    'Hvis opplysningene er hentet fra andre instanser enn NAV, \n' +
    'må du henvende deg til kilden som er oppgitt. Hvis du ønsker\n' +
    'å rette eller slette opplysninger om et arbeidsforhold, \n' +
    'må du henvende deg til arbeidsgiveren. \n' +
    'Hvis  arbeidsgiveren ikke lenger eksisterer, kan du kontakte NAV. \n' +
  ...
  },
  {
    ...
    content: {
      __html: 'Denne siden er under utvikling. Derfor er det ikke sikkert du finner alle opplysninger NAV har om deg her. Det kan være både tekniske \n' +
  ...
  },
  {
    ...
    content: {
      __html: 'Hvis du har spørsmål eller er uenig i vår behandling av dine personopplysninger, kan du kontakte NAV Kontaktsenter, \n' +
    'tlf. 55 55 33 33, eller bruke «Send beskjed til NAV».\n' +
    '\n' +
    'Du kan også kontakte NAVs personvernombud. \n' +
    '\n' +
