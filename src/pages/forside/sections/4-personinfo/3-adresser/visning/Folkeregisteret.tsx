    ...
    <div>
      ...
      {kontaktadresser.map((adr) => {
        ...
        if (utenlandskeAdressetyper.includes(adr.adresse?.type!)) {
          ...
          if (
            kontaktadresser.filter((kontaktadresse) =>
              utenlandskeAdressetyper.includes(kontaktadresse.adresse?.type!)
            ).length > 0
          ) {
