...
import utbetalingerStyles from "../Utbetalinger.module.css";
import styles from "./KontonummerForm.module.css";
...
const KontonummerForm = (props: Props) => {
    ...
    return (
        <FormProvider {...methods}>
            <form className={styles.kontonummerForm} onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className={utbetalingerStyles.knapper}>
