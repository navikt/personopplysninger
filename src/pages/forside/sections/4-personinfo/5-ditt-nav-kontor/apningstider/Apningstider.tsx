...
const Apningstider = (props: Props) => {
    ...
    return (
        <div className="apningstider">
            {aapningstider.length > 0 && <FormaterApningstider apningstider={aapningstider} />}
            {spesielleAapningstider.length > 0 && <FormaterApningstider apningstider={spesielleAapningstider} isSpesielleAapningstider={true} />}
        </div>
    );
};
