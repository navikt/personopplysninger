// TODO midlertidig fjern test (SyntaxError: Cannot use import statement outside a module)
...
describe('DittNavKontor', () => {
    it('renders correctly', () => {
        ...
        //         <DittNavKontor
        //             enhetKontaktInformasjon={personInfo.enhetKontaktInformasjon as unknown as EnhetKontaktInfo}
        //             geografiskTilknytning={personInfo.adresser.geografiskTilknytning as unknown as GeografiskTilknytning}
        //         />
        //     </IntlProvider>
        // </StoreProvider>
