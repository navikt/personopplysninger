...
export default {
  ...
  "adresse.hjelpetekster.adressetyper": `<p>Postadresse inneholder gatenavn, gatenummer og postnummer.</p>`,
  "adresse.hjelpetekster.postboksadresse": `<p>Postboksadresse viser til en postboks på et postkontor eller post i butikk.</p>`,
  "adresse.hjelpetekster.omradeadresse": `<p>Områdeadresse viser til et sted, for eksempel en gård, og inneholder ikke gatenavn</p>`,
  ...
  "adresse.hjelpetekster.bankkonto": `<p>For {land} kan du oppgi både BIC/Swift-kode og bankkode. Du kan oppgi begge, men det er tilstrekkelig med en av kodene.</p>`,
  ...
  "felter.landetbrukerbankkode.advarsel": `Du må fylle inn minst et av de to feltene under.`,
