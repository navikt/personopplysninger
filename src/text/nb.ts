...
export default {
  ...
  "dittnavkontor.beskrivelse": `Hvis du allerede får oppfølging ved et NAV-kontor, kan du fortsette å bruke dette kontoret. Hvis du ikke får oppfølging, kan du bruke kontoret under.`,
