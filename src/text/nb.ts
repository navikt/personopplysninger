...
export default {
  ...
  "personalia.bankkonto.alert": `På grunn av tekniske oppgraderinger er det ikke mulig å registrere eller endre kontonummer. Vi beklager dette, og ber deg forsøke igjen senere.`,
