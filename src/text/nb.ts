...
export default {
  ...
  "adresse.hjelpetekster.adressetyper": `<p>Postadresse inneholder gatenavn, gatenummer og postnummer.</p><p>Postboksadresse viser til en postboks på et postkontor eller post i butikk.</p><p>Områdeadresse viser til et sted, for eksempel en gård, og inneholder ikke gatenavn</p>`,
