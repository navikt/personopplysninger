...
Et barn som bor fast hos både mor og far, kan ha to bostedsadresser. Den ene adressen er registrert under delt bosted.`,
  ...
  NAV henter kontaktopplysningene dine fra Kontakt- og reservasjonsregisteret. Dette er et felles, nasjonalt register som brukes av det offentlige 
  for å kunne sende meldinger og dokumenter. Du kan også registrere telefonnumre du vil kontaktes på  i NAV sitt register.`,
    ...
    'lenker.dsop.info':
        'Dette er en logg som viser hvilke opplysninger vi har utlevert til forsikringsselskap basert på samtykke du har gitt på Altinn. <a>Se samtykket i Altinn.</a>',
