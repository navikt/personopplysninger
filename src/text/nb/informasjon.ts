export default {
  ...
  savneropplysninger: {
    ...
    melding:
      ...
      `<p>Savner du personopplysninger eller lurer du på om NAV har flere personopplysninger om deg, kan du bruke <beskjedLenke>Send beskjed til NAV</beskjedLenke> eller henvende deg til NAV Kontaktsenter, tlf. <telefonLenke>55 55 33 33</telefonLenke>.</p>`,
  },
  utlevere: {
  ...
  klage: {
    ...
    melding:
      `<p>Hvis du har spørsmål om vår behandling av dine personopplysninger, kan du bruke <beskjedLenke>Send beskjed til NAV</beskjedLenke> eller henvende deg til NAV Kontaktsenter, tlf. <telefonLenke>55 55 33 33</telefonLenke>.</p>` +
      ...
      `Informasjon om hvordan du går frem finner du på nettsidene til <datatilsynetLenke>Datatilsynet</datatilsynetLenke>. </p>` +
