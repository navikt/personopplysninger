export default {
    feilopplysninger: {
        ...
        melding: `<p>Hvis personopplysninger om deg er feil, kan du be om at de blir rettet. 
            ...
            men NAV har som regel lovbestemt plikt til å lagre opplysningene.</p>
            <p>Hvis personopplysningene er hentet fra andre kilder enn NAV, kan du henvende deg til kilden som er oppgitt.</p>
            <p>Hvis kilden er NAV, kan du bruke <beskjedLenke>Send beskjed til NAV</beskjedLenke> eller henvende deg til
    ...
    savneropplysninger: {
        ...
        melding: `<p>Denne siden er under utvikling. Derfor er det ikke sikkert du finner alle personopplysninger NAV har om deg her. 
            ...
            bruke <beskjedLenke>Send beskjed til NAV</beskjedLenke> eller henvende deg til NAV Kontaktsenter,
    ...
    klage: {
        ...
        melding: `<p>Hvis du har spørsmål om vår behandling av dine personopplysninger, kan du bruke <beskjedLenke>Send beskjed til
            ...
            eller hvis du mener behandlingen er i strid med personvernreglene. 
