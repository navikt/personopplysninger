...
export default {
  ...
  "personalia.bankkonto.alert": `På grunn av tekniske oppgraderingar er det ikkje mogleg å registrere eller endre kontonummer. Vi beklagar dette, og ber deg prøve igjen seinare.`,
