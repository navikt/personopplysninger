...
Eit barn som bur fast hos både mor og far, kan ha to bustadadresser. Den eine adressa er registrert under delt bustad.`,
    ...
    'dsop.ingendata': 'Ingen personopplysningar har blitt utlevert.<br></br><br></br>' + merInfo.dsop.info,
    ...
    'lenker.arbeidsforhold.beskrivelse': 'Sjå arbeidsforholda dine i Aa-registeret',
    ...
    'lenker.cv.tittel': 'CV',
    'lenker.cv.beskrivelse': 'Sjå CV-en og jobbprofilen din',
    ...
    'endreKontonummer.info':
        'Du kan ikkje endre kontonummer for økonomisk sosialhjelp eller andre kommunale tenestar her. <lenkeNavno>Endre kontonummer for utbetalingar frå kommunen.</lenkeNavno>',
    'endreKontonummer.lenkeURL': 'https://www.nav.no/kontonummer/nn#kommune',
