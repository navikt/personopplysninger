...
export default {
  ...
  "header.obs": `Her kan du sjå opplysningar som NAV har registrert om deg. Du har rett til innsyn i personopplysningar NAV har registrert om deg, men det er ikkje sikkert du vil finne alle personopplysningar her. Det kan vere på grunn av både tekniske og juridiske avgrensingar.`,
  "personalia.tittel": `Personalia`,
  "personalia.beskrivelse": `Vi må vite kven du er og korleis vi kan kontakte deg. Dersom du skal ha tenester eller søker om økonomisk støtte, treng vi opplysningar for å kunne vurdere kvar du har krav på. For å kunne utbetale pengar må vi ha kontonummeret ditt og ei adresse.`,
  "personalia.first_name": `Fornamn`,
  "personalia.first_and_middle_name": `For- og mellomnamn`,
  ...
  "personalia.tlfnr.ingenData": `Vi har ikkje registrert telefonnummer på deg i våre register. <br></br>Har du eit telefonnummer vi kan kontakte deg på?`,
...
Ein adresse som du oppheld deg på for tida.<br></br><br></br>
...
Eit barn som bur fast hos både mor og far, kan ha to bustadadresser. Den eine adressa er registrert under delt bustad.`,
  ...
  "adresse.hjelpetekster.adressetyper": `<p>Postadresse inneheld gatenamn, gatenummer og postnummer.</p><p>Postboksadresse viser til ein postboks på eit postkontor eller post i butikk.</p>`,
  "adresse.hjelpetekster.gyldigtil": `<p>Du kan sjølv velje kor lenge adressa skal være gyldig, maksimalt 1 år. Etter 1 år må du endre eller forlenge adressa.</p>`,
  "adresse.hjelpetekster.co": `<p>Bur du midlertidig på ein annan persons adresse og ønsker posten dit? Då må posten være merka med den andre personen sitt namn. Det er ekstra viktig viss namnet ditt ikkje står på postkassa.</p>`,
  ...
  "adresse.hjelpetekster.bygningetasjeleilighet": `<p>Fyllast ut dersom adressa inneheld informasjon om bygning. Dømer er leiligheitsnummer, oppgang, suite, namn på bygg og etasje.</p>`,
  "adresse.hjelpetekster.regiondistriktomraade": `<p>Fyllast ut dersom adressa inneheld namn på region eller område. Dømer er distrikt, stat og landsby.</p>`,
  "adresse.hjelpetekster.utenlandsk.adresse": `<p>Dersom det ikkje er mogleg å skilje ut region, bygning, postkode eller stadsnann frå adressa, kan du skrive inn heile adressa i feltet adresse, slik den er oppgitt. Informasjonen skal ikkje stå fleire stadar.</p>`,
  "adresse.hjelpetekster.tilleggsnavn": `<p>Adressetilleggsnamn er eit tillegg i den offisielle adressa.</p><p>Dette kan for eksempel vere namn på gardsbruk, kjente institusjonar/bygningar, grender, bustadsfelt, hyttefelt eller liknande.</p>`,
  "arbeidsforhold.tittel": `Arbeidsforhold`,
  "arbeidsforhold.beskrivelse": `<p>NAV treng informasjon om arbeidsforholda dine for å kunne vurdere behovet ditt for oppfølging og tenester frå NAV, og til å rekne ut kor mykje du kan få utbetalt i for eksempel sjukepengar, dagpengar og foreldrepengar. Andre offentlege etatar har også tilgang til opplysningar frå Arbeidsgiver og arbeidstakerregisteret.</p><p>Det er Arbeids- og velferdsetaten som eig og forvaltar Arbeidsgiver og arbeidstakerregisteret (Aa-registeret).<br></br><lenkeAaRegisteret>Her finn du meir informasjon om Arbeidsgiver- og arbeidstakerregisteret</lenkeAaRegisteret>.</p>`,
  "arbeidsforhold.kilde": `Kjelde: Arbeidsgiver- og arbeidstakerregisteret<br></br><span>Dataane er rapportert av arbeidsgivar</span>`,
  "arbeidsforhold.disclaimer": `Oversikta viser alle arbeidsforhold rapportert etter 01.01.2015.<br></br>Dersom det er feil i eit arbeidsforhold, kan arbeidsgivaren endre gjennom a-meldinga.`,
  "arbeidsforhold.submitted.by": `Dataane er rapportert av arbeidsgivar`,
  "utbetalinger.tittel": "Kontonummer for utbetaling",
  "utbetalinger.hjelpetekster.kontonummer": `<p>Når du mottek ytingar frå NAV må du oppgi ein bankkonto som står i ditt namn. Adressa som NAV har registrert på deg må være lik den du har oppgitt til den utanlandske banken. </p><p>For utbetaling til europeiske bankar MÅ du oppgi IBAN. IBAN startar alltid med registrering av to bokstaver utan mellomrom, deretter kjem mellom 15 og 31 tal, avhengig av krava i det enkelte land. Eksempel: DK12389325974125698</p><p>Oppgir du IBAN-nummer, må du oppgi BIC.</p><p>Kontonummer som ikkje er IBAN, kan ha BIC.</p>`,
  "utbetalinger.hjelpetekster.bic": `<p>BIC/SWIFT er eit internasjonalt system som vert nytta til å identifisere banker. Du får oppgitt BIC av banken din. BIC/SWIFT-koda inneheld 8 eller 11 bokstavar.</p><p>Har du ein europeisk bankkonto må du oppgi både BIC-kode og IBAN.</p><p>Dersom landet nyttar bankkode, skal du oppgi BIC for dei bankane som har BIC.</p>`,
  "utbetalinger.hjelpetekster.valuta": `<p>Gebyra kan bli lågare dersom du vel utbetaling i valutaen til landet du har busett deg i. Sjekk med banken kva som lønner seg. Har du ein konto som er knytt opp mot ein bestemt valuta (valutakonto), oppgir du denne valutaen til NAV.</p><p>Finn du ikkje valutaen på lista, kan du velje ein hovudvaluta: Amerikanske dollar (USD) eller euro (EUR).</p>`,
  "utbetalinger.hjelpetekster.bankkode": `<p>I dette feltet fyller du ut bankkode, fedwire number (FW) eller routing number.</p><p>Oppgir du ei bankkode, treng du ikkje oppgi IBAN-nummer. Du oppgir BIC for de bankane som har det.</p><p>Land som bruker bankkode, er blant anna USA, Australia, Canada, Russland, New Zealand og Sør-Afrika.</p>`,
  ...
  "skattetrekksmeldinger.ingendata":
    "Ingen skattetrekksmeldinger har blitt henta",
  ...
  "medl.situasjoner.1": `Flyttar du til utlandet for å bu eller jobbe, avhenger medlemskap i folketrygda blant anna av kva du gjer og varigheita på opphaldet.`,
  "medl.situasjoner.2": `Norske studentar i utlandet vil vanlegvis vere pliktige medlem i folketrygda viss dei får støtte frå Lånekassen for å studere på heiltid ved eit utanlandsk universitet eller en høgskule.`,
  "medl.situasjoner.3": `Er du busett i eit anna land, men jobbar heilt eller delvis i Norge, kan du vere med i trygdeordninga i bustadslandet ditt og være unnteke frå medlemskap i folketrygda.`,
  ...
  "medl.medlemskap.uten.ingress": `Oversikta viser periodar der NAV har fått informasjon fra trygdemyndigheten i et annet land om at du var med i trygdeordninga i bustadslandet ditt mens du jobba i Norge.`,
  ...
  "medl.hjemmel": "Heimel",
  "medl.hjemmel.hjelpetekst": `Heimel viser grunnlaget ditt for medlemskap i folketrygda (lov eller avtale). Er du unnateke frå medlemskap i folketrygda, viser den grunnlaget for unntak.`,
  ...
  "lenker.pensjon.beskrivelse": `Sj pensjonsoppteninga di og rekn ut alderspensjonen din.`,
  ...
  "lenker.dinesaker.tittel": `Dine sakar`,
  "lenker.dinesaker.beskrivelse": `Sjå sakane og dokumenta dine, og kommunikasjonen din med NAV.`,
  ...
  "lenker.dsop.tittel": `Utlevering av personopplysingar`,
  ...
  "lenker.inst.beskrivelse": `Se dine institusjonsopphald`,
  "lenker.skattetrekksmelding.tittel": `Skattetrekksmeldingar`,
  "lenker.skattetrekksmelding.beskrivelse": `Se dine skattetrekksmeldingar`,
  ...
  "lenker.tilrettelegging.beskrivelse": `Se kva behov du har for tilrettelegging for å kunne jobbe. Behova er registrert av rettleiar.`,
  ...
  "felter.utenlandskkonto.info": `Ver nøye med utfylling av bankinformasjon for utanlandsk konto slik at betalinga kjem fram til rett stad. NAV er ikkje ansvarleg for at opplysningane er rette. Det kan vere gebyr. Les meir om krav til <a> utanlandsk kontonummer </a>.`,
  ...
  "felter.landetbrukerbankkode.advarsel": `For <span>{land}</span> kan du oppgi både BIC/Swift-kode og bankkode. Du kan oppgi begge, men det er tilstrekkeleg med ei av kodene.`,
