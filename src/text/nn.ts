...
Eit barn som bur fast hos både mor og far, kan ha to bustadadresser. Den eine adressa er registrert under delt bustad.`,
  ...
  "medl.situasjoner.2": `Norske studentar i utlandet vil vanlegvis vere pliktige medlem i folketrygda viss dei får støtte frå Lånekassen for å studere på heiltid ved eit utanlandsk universitet eller ein høgskule.`,
  ...
  "medl.medlemskap.uten.ingress": `Oversikta viser periodar der NAV har fått informasjon frå trygdemyndigheitene i eit land om at du var med i trygdeordninga i bustadslandet ditt mens du jobba i Norge.`,
  ...
  "lenker.fullmakt.beskrivelse": `Sjå fullmaktene`,
