...
A child who lives permanently with both mother and father can have two home addresses, one of which is registered under shared housing.`,
    ...
    'adresse.hjelpetekster.gyldigtil':
        '<p>You choose how long the address is to be valid, a maximum of 1 year. After 1 year, you need to change or extend the address.</p>',
    'adresse.hjelpetekster.co':
        "<p>Are you temporarily staying at another person's address and want the post to go there? If so, the post must be marked with the other person's name. This even more important if your name is not on the mailbox.</p>",
    ...
    'adresse.hjelpetekster.bygningetasjeleilighet':
        '<p>To be filled out if the address contains information about the building. Examples include flat number, entrance, suite, name of building and floor.</p>',
    'adresse.hjelpetekster.regiondistriktomraade':
        '<p>To be filled out if the address contains name of region or area. Examples are district, state, and village.</p>',
  ...
  NAV uses your contact information from The common contact register. This is a joint national registry used by the government to send messages
  and documents. You can also register the phone number you want to be reached by in The NAV registry.`,
    ...
    'medl.oversikt.ingress':
        'If you work and live in Norway, you are normally a member of the National Insurance Scheme. Periods with this type of membership will not be shown in this page. This page is only relevant if you have',
    ...
    'medl.situasjoner.1':
        'If you move abroad to live or work, membership in the National Insurance Scheme depends on what you do and how long you stay.',
    'medl.situasjoner.2':
        'Norwegian students will normally be compulsory members of the National Insurance Scheme, if they receive funding from the State Educational Loan Fund (Lånekassen) to study at universities abroad.',
    'medl.situasjoner.3':
    ...
    'medl.lovvalgsland.hjelpetekst':
        "Information about which country's social security scheme you were part of, during the period you were exempt from membership in the National Insurance Scheme.",
    ...
    'dittnavkontor.beskrivelse':
        "If you are already receiving follow-up at a NAV office, you should continue to use this office. If you don't get follow-up, you can use the office below.",
    ...
    'lenker.beskrivelse':
        'We also have information about you that you do not see on this page. Go to the various services below and see information.',
    ...
    'lenker.dsop.info':
        'This is a log showing the information we have disclosed to insurance companies based on the consent you have given on Altinn.<a>See the consent in Altinn.</a>',
    ...
    'lenker.medl.beskrivelse':
        "See periods where you've stayed abroad, and periods where you have worked in Norway, and lived in a different country",
    ...
    'felter.kontonummer.grouplegend': 'Choose Norwegian or foreign account number',
    ...
    'felter.landetbrukerbankkode.advarsel':
        'For <span>{land}</span> you can provide both BIC/SWIFT code and bank code. You can provide both, but one code is sufficient.',
    ...
    'validation.tlfnr.makslengde': 'The phone number can have a maximum of 16 numbers',
