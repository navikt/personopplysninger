...
export default {
  ...
  "inst.disclaimer": `Here you can see information about stays in nursing homes and other health institutions. The overview shows only registered stays after 16 September 2020. If you notice errors in the information, you must contact the institution directly.`,
  "inst.periode": `Period`,
