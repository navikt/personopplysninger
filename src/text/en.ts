...
A child who lives permanently with both mother and father can have two home addresses, one of which is registered under shared housing.`,
    ...
    'adresse.hjelpetekster.co': `<p>Are you temporarily staying at another person's address and want the post to go there? If so, the post
    must be marked with the other person's name. This even more important if your name is not on the mailbox.</p>`,
  ...
  messages and documents. You can also register the phone number you want to be reached by in The NAV registry.`,
    ...
    'medl.lovvalgsland.hjelpetekst': `Information about which country's social security scheme you were part of, during the
    period you were exempt from membership in the National Insurance Scheme.`,
