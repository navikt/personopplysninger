...
A child who lives permanently with both mother and father can have two home addresses, one of which is registered under shared housing.`,
    ...
    'dsop.ingendata': 'No personal data has been disclosed.<br></br><br></br>' + merInfo.dsop.info,
  ...
  messages and documents. You can also register the phone number you want to be reached by in the Nav registry.`,
    ...
    'lenker.cv.tittel': 'CV (text in norwegian)',
    'lenker.cv.beskrivelse': 'See your CV',
    ...
    'lenker.dsop.beskrivelse':
        'See what information Nav shares with insurance companies because you have given consent" endres til "See what information Nav shares with insurance companies if you have given consent',
