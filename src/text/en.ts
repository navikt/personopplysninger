...
export default {
  ...
  "side.organisasjonsnummer": "Organisation number {org. no.}",
  "side.endre": "Change",
  ...
  "adresse.midlertidigadresse.leggtil.beskrivelse": `You have not registered a temporary address. <br></br>If you want to receive post from NAV at a temporary address, you can register the address.`,
  ...
  "utbetalinger.hjelpetekster.kontonummer": `<p>When you receive benefits from NAV, you must provide a bank account that is in your name. The address registered by NAV under your name must be identical to the one you have provided to the foreign bank. </p><p>You must provide an IBAN for payment to European banks. Some countries outside Europe also use IBAN. IBAN starts with a country code with two uppercase letters with no spaces. This is followed by between 15 and 31 alphanumeric characters; the number varies between countries.</p><p>If you provide an IBAN number, you must provide a BIC.</p><p>Account numbers that are not IBANs may have a BIC.</p>`,
  ...
  "inst.disclaimer": `Here you can see information about stays in prison, nursing homes and other health institutions. The overview shows only registered stays after 1. january 2017. If you notice errors in the information, you must contact the institution directly.`,
  "inst.periode": `Period`,
  ...
  "felter.landetbrukerbankkode.advarsel": `For <span>{country}</span> you can provide both BIC/SWIFT code and bank code. You can provide both, but one code is sufficient.`,
  ...
  "validation.iban.pakrevd": "Valid IBAN is required",
  ...
  "validation.bankkode.lengde": `Bank codes from {country} must have {digits} numbers`,
